...
--   ["ExtG"] = { first = 0x30000, last = 0x3134A },      -- CJK Unified Ideographs Extension G - https://unicode.org/charts/PDF/U30000.pdf
   ...
   ["ext1"]={first=0x3400,last=0x340D},["ext2"]={first=0x340F,last=0x4DBF},  --保留U+340E㐎
   ["ext3"]={first=0x20000,last=0x2003D},["ext4"]={first=0x2003F,last=0x323AF}  --保留U+2003E𠀾
...
local function is_cjk_ext(c)
   return is_charset("ext1")(c) or is_charset("ext2")(c) or
      is_charset("ext3")(c) or is_charset("ext4")(c) or
      is_charset("Compat")(c) or is_charset("CompatSupp")(c)
end
